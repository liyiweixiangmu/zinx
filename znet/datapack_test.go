			...
			go func(conn net.Conn) {
				...
				for {
					...
					if msgHead.GetMsgLen() > 0 {
						...
						// 完整的一个消息已经读取完毕
						fmt.Println(" ----> Reveice MsgID: ", msg.Id, " datalen = ", msg.DataLen, " data = ", string(msg.Data))
					}
